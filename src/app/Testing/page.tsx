...
export default function JourneyTimeline() {
  ...
  return (
    <div className="min-h-screen text-white p-6 mx-auto container">
      <Header />
      <div className="min-h-screen text-white p-6 mx-auto  px-4 mt-36 sm:mt-24 md:mt-8">
        <motion.div
          ref={ref1}
        ...
        >
          ...
          >
            ...
            <p className="text-gray-200">
              My journey began in secondary school (2019-2020), where I
              developed an interest in computer science. I learned HTML, CSS,
              JavaScript, MySQL, and PHP, and my first major project was a car
              selling system. This project taught me the basics of full-stack
        ...
        >
          ...
          >
            ...
            <p className="text-gray-200">
              Built Music App, Sports Platform, Expenses Tracker, and Reka
              Konsult Company Profile.
            </p>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-200">
              Participated in DevMatch, Google Cloud, Canva Hackathon, Ethereum
              KL 2024. Explored Ethereum, Solana, and Web3.
            </p>
